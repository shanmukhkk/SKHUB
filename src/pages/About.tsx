  ...
  const team = [
    {
      ...
      bio: 'With over 15 years of experience in the hospitality industry, RK working as CEO in place of SK.SKHUB to revolutionize the nightlife scene in Bhimavaram.'
    },
    {
      name: 'Priya Sharma',
